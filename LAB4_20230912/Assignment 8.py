...
char_ratio = tuple()
char_ratio += (letter[ratio.index(s_ratio[0])], )
char_ratio += (letter[ratio.index(s_ratio[1])], )
char_ratio += (letter[ratio.index(s_ratio[2])], )
char_ratio += (letter[ratio.index(s_ratio[3])], )
...
print('        1) "{}" with {} points'.format(char_amount[0], s_amount[-1]))
print('        2) "{}" with {} points'.format(char_amount[1], s_amount[-2]))
print('        3) "{}" with {} points'.format(char_amount[2], s_amount[-3]))
print('        4) "{}" with {} points'.format(char_amount[3], s_amount[-4]))

print("The lowest ratio in the scrabble game:")
print('        1) "{}" with {} points'.format(char_ratio[0], s_ratio[0]))
print('        2) "{}" with {} points'.format(char_ratio[1], s_ratio[1]))
print('        3) "{}" with {} points'.format(char_ratio[2], s_ratio[2]))
print('        4) "{}" with {} points'.format(char_ratio[3], s_ratio[3]))